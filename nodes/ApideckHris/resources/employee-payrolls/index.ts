...
export const employeePayrollsDescription: INodeProperties[] = [
		{
			...
			"options": [
				{
					"name": "Employee Payrolls All",
					"value": "Employee Payrolls All",
					"action": "List Employee Payrolls",
					"description": "List payrolls for employee",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/hris/payrolls/employees/{{$parameter[\"employee_id\"]}}"
						}
					}
				},
				{
					"name": "Employee Payrolls One",
					"value": "Employee Payrolls One",
					"action": "Get Employee Payroll",
					"description": "Get payroll for employee",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/hris/payrolls/employees/{{$parameter[\"employee_id\"]}}/payrolls/{{$parameter[\"payroll_id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /hris/payrolls/employees/{employee_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /hris/payrolls/employees/{employee_id}/payrolls/{payroll_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
