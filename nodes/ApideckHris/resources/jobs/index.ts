...
export const jobsDescription: INodeProperties[] = [
			...
			"options": [
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/hris/jobs/employees/{{$parameter[\"employee_id\"]}}"
						}
					}
				},
				{
					...
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/hris/jobs/employees/{{$parameter[\"employee_id\"]}}/jobs/{{$parameter[\"job_id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /hris/jobs/employees/{employee_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /hris/jobs/employees/{employee_id}/jobs/{job_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
