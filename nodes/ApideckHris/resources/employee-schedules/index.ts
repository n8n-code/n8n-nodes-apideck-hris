...
export const employeeSchedulesDescription: INodeProperties[] = [
                {
			...
			"options": [
				{
					"name": "Employee Schedules All",
					"value": "Employee Schedules All",
					"action": "List Employee Schedules",
					"description": "List schedules for employee, a schedule is a work pattern, not the actual worked hours, for an employee.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/hris/schedules/employees/{{$parameter[\"employee_id\"]}}"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /hris/schedules/employees/{employee_id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
