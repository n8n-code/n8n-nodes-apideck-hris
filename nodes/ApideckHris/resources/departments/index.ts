...
export const departmentsDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/hris/departments/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Departments One",
					"value": "Departments One",
		...
		{
			"displayName": "GET /hris/departments",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /hris/departments",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /hris/departments/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /hris/departments/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PATCH /hris/departments/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
